...
const SettingsPage = () => {
  ...
  const url = `comment-manager/page-size`
  useEffect(() => {
  ...
  return (
    <Box background="neutral100" padding={8}>
      <Box paddingBottom={3} paddingTop={3}>
        <Typography variant="alpha" fontWeight="bold">Comments Manager settings</Typography>
      </Box>
      <Box background="neutral0" padding={6}>
        <Stack size={2}>
          <Typography variant="beta">
            Specify how many comments to return for each page.
          </Typography>
